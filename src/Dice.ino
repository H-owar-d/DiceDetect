...
#define DICE_NUM  3//0xFF //0xFF means always show
...
VideoSetting config_JPEG(VIDEO_FHD, 30, VIDEO_JPEG, 1);
//VideoSetting config_JPEG(1024, 576 , 30, VIDEO_JPEG, 1);
VideoSetting configNN(NNWIDTH, NNHEIGHT, 10, VIDEO_RGB, 0);
VideoSetting configNN_JPEG(NNWIDTH, NNHEIGHT, 10, VIDEO_JPEG, 1);
...
//char pass[] = "2a43b09ff7";        // your network password
char ssid[] = "STIPC-GUEST";
char pass[] = "12345678";
...
void setup()
{
    ...
    Camera.configVideoChannel(CHANNEL, config_JPEG);
    Camera.videoInit();
    Camera.channelBegin(CHANNEL);
    ...
    OSD.configVideo(CHANNEL, config_JPEG);
    OSD.begin();
...
/*
        ...
        else if ((digitalRead(button) == true) && (bisPress) && (!breleaseprint))
        {
            bisPress = false;
            breleaseprint = true;
